...
OnvifHttpAuth.prototype._createAuthReqHeaderValue = function(o) {
	...
	let response = ""
	if( o.qop == "auth" || o.qop == "auth-int"){
		response = this._createHash(o.algorithm, [ha1, o.nonce, nc, cnonce, o.qop, ha2].join(':'));
	}
	else{
		response = this._createHash(o.algorithm, [ha1, o.nonce, ha2].join(':'));
	}
